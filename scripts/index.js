...
const closeAddButtonElement = document.querySelector('.popup-add__close-button');
...
const closeImageButtonElement = document.querySelector('.popup-image__close-button');
